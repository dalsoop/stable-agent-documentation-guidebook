...
- **One reader test, for one document.** The context file passed a reader test with two agents on 2026-09-25 ([snapshot](../snapshots/2026-09-25-reader-test/README.md)). Run 1 found two defects in it. After the fix, run 2 found a third defect, in code that disagreed with the document. The other documents have no named reader and no reader test yet.
