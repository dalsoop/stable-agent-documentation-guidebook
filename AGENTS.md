...
- Change the original first. Then update each translation, and put the output of `shasum -a 256 <original>` in its first line. (Reason: the check fails when a translation does not follow its original.)
